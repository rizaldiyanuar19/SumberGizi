<nav class="navbar sticky-top navbar-expand-lg navbar-dark">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link <?= $this->uri->segment(2) == 'men' ? 'active' : '' ?>" href="<?= base_url('shop/men') ?>">Premenium</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= $this->uri->segment(2) == 'women' ? 'active' : '' ?>" href="<?= base_url('shop/women') ?>">Standar</a>
                </li>
            </ul>
