       ...
       <div class="row">
           <div class="col-lg-6 col-md-6 col-sm-12">
               <a href="<?= base_url('shop/men') ?>">
                   <div class="single_promo">
                       <img src="<?= base_url() ?>assets/img/Sapi-3.jpg" alt="...">
                       <div class="box-content">
                           <h3 class="title">daging Sapi Premenium</h3>
                       </div>
                   </div>
               </a>
           </div>
           <div class="col-lg-6 col-md-6 col-sm-12">
               <a href="<?= base_url('shop/women') ?>">
                   <div class="single_promo">
                       <img src="<?= base_url() ?>assets/img/Sapi-2.jpg" alt="...">
                       <div class="box-content">
                           <h3 class="title">daging Sapi Standar</h3>
                       </div>
                   </div>
               </a>
           </div>
