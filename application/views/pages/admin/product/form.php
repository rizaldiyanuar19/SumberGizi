    ...
    <div class="card-body">
        <?= form_open_multipart($form_action, ['method' => 'POST']) ?>
            ...
            <div class="form-group">
                ...
                <?= form_input('size', $input->size, ['class' => 'form-control', 'placeholder' => 'Contoh: 1 kg, 2 kg, 3 kg, 4 kg, ...', 'required' => true]) ?>
                <?= form_error('size') ?>
            </div>
            <div class="form-group">
                <label for="">Varian</label>
                <?= form_input('color', $input->color, ['class' => 'form-control', 'placeholder' => 'Contoh: daging dadu, daging giling, daging halal, ...', 'required' => true]) ?>
            </div>
            <div class="form-group">
                ...
                <div class="form-check form-check-inline">
                    ...
                    <label for="" class="form-check-label">Premenium</label>
                </div>
                <div class="form-check form-check-inline">
                    <?= form_radio(['name' => 'type', 'value' => 'W', 'checked' => $input->type == 'W' ? true : false, 'class' => 'form-check-input']) ?>
                    <label for="" class="form-check-label">Standar</label>
                </div>
            </div>
            <div class="form-group">
